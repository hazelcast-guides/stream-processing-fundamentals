...
public class TemperatureMonitorPipeline {
    ...
    public static Pipeline createPipeline(Properties kafkaConnectionProps,
        ...
        /*
         * At any point in the pipeline you can view the contents by writing the results to a logging Sink  or
         * with the "peek" method.  This can be helpful during development.  Be sure to remove this when you are
         * done since logging can slow down event processing.
         */
        rawEvents.writeTo(Sinks.logger(event -> "Received event for " + event.getKey()));
         ...
         *
         */
        ServiceFactory<?, ObjectMapper> jsonParserFactory = null;
        StreamStage<MachineEvent> machineEvents = null;
